...
public class DpkgPackageManagerTest {
    ...
    public void test() throws ExecutableRunnerException, NotOwnedByAnyPkgException {
        String pkgMgrOwnedByOutput = getDpkgOwnedByOutputLibC6Dev();
        String pkgMgrVersionOutput = getDpkgVersionOutputLibC6Dev();
        ExecutableRunner executableRunner = Mockito.mock(ExecutableRunner.class);
        Mockito.when(executableRunner.execute(null, "dpkg", Arrays.asList("-s", "libc6-dev"))).thenReturn(new ExecutableOutput("", 0, pkgMgrVersionOutput, ""));
    ...
    public void testEpoch() throws ExecutableRunnerException, NotOwnedByAnyPkgException {
        ...
        String pkgMgrOwnedByOutput = getDpkgOwnedByOutputStdLib();
        String pkgMgrVersionOutput = getDpkgVersionOutputStdLib();

        ExecutableRunner executableRunner = Mockito.mock(ExecutableRunner.class);
        Mockito.when(executableRunner.execute(null, "dpkg", Arrays.asList("-s", "login"))).thenReturn(new ExecutableOutput("", 0, pkgMgrVersionOutput, ""));
    ...
    @NotNull
    private String getDpkgVersionOutputStdLib() {
        StringBuilder sb;
    ...
    @NotNull
    private String getDpkgOwnedByOutputStdLib() {
    ...
    @NotNull
    private String getDpkgOwnedByOutputLibC6Dev() {
        StringBuilder sb = new StringBuilder();
        sb.append("garbage\n");
        sb.append("nonsense\n");
    ...
    @NotNull
    private String getDpkgVersionOutputLibC6Dev() {
        StringBuilder sb;
        sb = new StringBuilder();
